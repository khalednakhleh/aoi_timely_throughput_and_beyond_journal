...
q = [0.8, 0.95, 0.45, 0.2, 0.1, 0.55, 0.5, 0.85, 0.3, 0.75];
p = [0.25, 0.65, 0.2, 0.4, 0.845, 0.35, 0.6, 0.85, 0.15, 0.45];
...
lambdas = [0.1, 0.1, 0.1, 0.05, 0.05, 0.05, 0.25, 0.1, 0.05, 0.05]%, 0.2, 0.2, 0.2, 0.1]; %,0.5,0.5,0.5,0.5] % for two clients
