...
p = [0.9, 0.75, 0.65, 0.5, 0.8]   %, 0.4, 0.7, 0.8, 0.45, 0.25, 0.15];
q = [0.3, 0.2, 0.7, 0.35, 0.4]   %, 0.4, 0.3, 0.4, 0.55, 0.45, 0.65];
...
lambdas = [0.05, 0.05, 0.05, 0.05, 0.05];%, 0.1, 0.2, 0.2, 0.01, 0.05]%, 0.2, 0.2, 0.2, 0.1]; %,0.5,0.5,0.5,0.5] % for two clients
